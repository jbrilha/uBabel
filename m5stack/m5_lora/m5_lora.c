...
void start_lora_receiver_task() {
    ...
    spi_device_interface_config_t dev_cfg = {.clock_speed_hz = 1E6,
                                             .spics_io_num = SS,
                                             .queue_size = 16,
                                             .command_bits = 0,
                                             .address_bits = 8,
    ...
    ESP_ERROR_CHECK(sx127x_set_frequency(868000000, &device));
...
int supported_power_levels[] = {2,  3,  4,  5,  6,  7,  8,  9, 10,
